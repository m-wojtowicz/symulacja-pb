...
public class WykonanieRuchu {
    ...
    public static void wykonanieRuchu() {
        for(Dowodca dowodca : Symulacja.listaDowodcow) {
            ...
            final Oddzial.Ruch ruch = dowodca.decyzja();
    ...
    private static void zmienMapePoRuchu(final Oddzial.Ruch ruch) {
        ...
        if(ruch.odczytajTypRuchu() == Oddzial.Ruch.TypRuchu.PRZEMIESZCZENIE) {
        ...
        if(ruch.odczytajTypRuchu() == Oddzial.Ruch.TypRuchu.PRZEJECIE) {
        ...
        if(ruch.odczytajTypRuchu() == Oddzial.Ruch.TypRuchu.ATAK) {
            ...
            Oddzial.przeliczStatystyki(docelowePole.odczytajOddzial());
            Oddzial.przeliczStatystyki(poczatkowePole.odczytajOddzial());
